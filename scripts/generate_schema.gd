...
var PropertyUsageFlags:Dictionary = {
...
func get_property_info( property_name : StringName ) -> Dictionary:
	...
	var prop_idx:int = prop_list.find_custom(
		func(prop_info:Dictionary) -> bool: 
			return prop_info.name == property_name )
...
var scalar_types:Array = [TYPE_INT, TYPE_FLOAT, TYPE_BOOL]
var struct_types:Array = []
var array_types:Array = ["String"]

func _run() -> void:
	var object := MyObject.new()

	var prop_list:Array[Dictionary] = object.get_property_list()
	...
	var object_table:String =  generate_table( "MyObject", object )
...
func generate_schema( root : String, chunks : Array[String] ) -> String:
	var lines:Array[String] = ["// Generated By gdflatbuffers"]
...
func generate_table( type : String, object:Object ) -> String:
